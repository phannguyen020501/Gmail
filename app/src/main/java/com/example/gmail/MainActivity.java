...
public class MainActivity extends AppCompatActivity {
    ...
    public void getEmailList() {
        ...
        emailList.add(new Item("Phan Nguyen", "Hello, long time no see!", "9:34 PM"));
        emailList.add(new Item("Hung Nguyen", "Hi sir, please call me if you receive this mail", "8:30 AM"));
